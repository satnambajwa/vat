<div class="row">
    <div class="col-sm-12 card">
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="invoices-paid">
                <thead>
                    <tr>
                        <th>Code</th>
                        <th>Ref</th>
    ...
    <script>
        $(function() {
            var invoicesDraft = $('#invoices-paid').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('get.data', "paid") !!}',
            ...
            $('#invoices-paid tbody').on( 'click', 'tr', function () {
